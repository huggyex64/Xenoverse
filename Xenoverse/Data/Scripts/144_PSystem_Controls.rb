...
if !$MKXP
  ...
  module Input
    ...
    # release? and releaseex? are not supported yet.
    # The only time I've ever seen them used for anything
    # is in some mouse control scripts which check to see
    # when the mouse is released after being pressed, 
    # in which case this works absolutely fine
