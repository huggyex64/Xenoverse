RETROMON = {
				...
				# pass 5
				:CATERPIE=>:CATERPIEVINTAGE,
				:METAPOD=>:METAPODVINTAGE,
				:BUTTERFREE=>:BUTTERFREEVINTAGE,
				:TYROGUE=>:TYROGUEVINTAGE,
				:SLUGMA=>:SLUGMAVINTAGE,

				#Pink pathway
				:PINECO=>:PINECOVINTAGE,
				:BELLOSSOM=>:BELLOSSOMVINTAGE,
				:ESPEON=>:ESPEONVINTAGE,
				:UMBREON=>:UMBREONVINTAGE,
				:HOUNDOOM=>:HOUNDOOMVINTAGE,
				:DRAGONAIR=>:DRAGONAIRVINTAGE
