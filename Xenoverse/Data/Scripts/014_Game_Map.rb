#==============================================================================
# CONVERSIONE GIORNO/NOTTE DEL CHIPSET
#==============================================================================

TIMESENSITIVETILESETS = {
  15 => 34 ,  28 => 35 , 19 => 36 , 22 => 37 , 23=> 38, 24 =>39 , 9 => 40 , 
  25 => 41, 76 => 88 , 52 => 89 , 72 => 90, 50 => 92, 70 => 93, 
  55 => 94, 65 => 91, 33 => 96, 44 => 51, 58 => 99, 
  66 => 84, 25 => 101, 102 => 103, 64 => 95, 108=>109
}
      ...
      for i in [2, 1, 0]
        ...
        # Can't walk onto ledges
          ...
          for j in [2, 1, 0]
            ...
            return false if facing_tile_id==nil
            if @terrain_tags[facing_tile_id]!=0
              return false if @terrain_tags[facing_tile_id]==PBTerrain::Ledge && $game_swiches[1203]==false
              break
            end
          end
