	...
	def pbPokemonDebug(pkmn,pkmnid)
		...
		loop do
			...
			when 0
				cmd=0
				loop do
					cmd=@scene.pbShowCommands_old(_INTL("Do what with {1}?",pkmn.name),[
							_INTL("Set HP"),
							_INTL("Status: Sleep"),
							_INTL("Status: Poison"),
							_INTL("Status: Burn"),
			...
			when 4
				if pkmn.gender==2
					...
					loop do
						...
						cmd=@scene.pbShowCommands_old(msg,[
								_INTL("Make male"),
								_INTL("Make female"),
			...
			when 10
				...
				loop do
					...
					cmd=@scene.pbShowCommands_old(_INTL("Personal ID is {1}.",persid),[
							_INTL("Set EVs"),
							_INTL("Set IVs"),
					...
					when 0
						...
						loop do
							...
							cmd2=@scene.pbShowCommands_old(_INTL("Change which EV?"),evcommands,cmd2)
							if cmd2==-1
								break
			...
			when 12
				...
				loop do
					...
					if cmd==-1
						...
						cmd2=@scene.pbShowCommands_old(_INTL("Set OT's gender."),
