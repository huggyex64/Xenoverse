...
class PokemonRegionMapScene
  ...
  def pbStartScene(aseditor=false,mode=0)
    ...
    @sprites["blackbar"]=EAMSprite.new(@viewport)
    @sprites["blackbar"].bitmap=Bitmap.new(512,30)
    @sprites["blackbar"].bitmap.fill_rect(0,0,512,30,Color.new(0,0,0))
    @sprites["blackbar"].opacity = 125
    @sprites["blackbar"].y=384-30
    @sprites["blackbar"].z=20
