...
def _INTL(*arg)
	...
	#end
	#echoln ""
	#if MessageTypes.messages.messages.last !=nil
	#	echoln MessageTypes.messages.messages.last[arg[0]] if arg[0]==MessageTypes.messages.messages.last.keys.last
	#	echoln MessageTypes.messages.messages.last.keys.last#"{1} sistema \\c[1]{2}\\c[0]\r\nnella tasca \\c[1]{3}\\c[0]"
	#	echoln arg[0]==MessageTypes.messages.messages.last.keys.last#"{1} sistema \\c[1]{2}\\c[0]\r\nnella tasca \\c[1]{3}\\c[0]"
    ...
    string=arg[0]
		if MessageTypes.messages.messages.last != nil && MessageTypes.messages.messages.last.keys.include?(arg[0])
			string=MessageTypes.messages.messages.last[arg[0]] 
		end
  end
  string=string.clone
