...
module PBDayNight
  HourlyTones=[
     Tone.new(-105,-95,-5,0),     # Midnight
     Tone.new(-105,-95,-5,0),
     Tone.new(-105,-95,-5,0),
     Tone.new(-105,-95,-5,0),
     Tone.new(-65,-75,-5,0),
     Tone.new(-65,-75,-5,0),
     Tone.new(-35,-55,-5,0),      # 6AM
     Tone.new(-35,-55,-5,0),
     Tone.new(-15,-45,-5,0),
     Tone.new(-15,-45,-5,0),
     Tone.new(0,     0,     0,    0),
     ...
     Tone.new(0,     0,     0,    0),
     Tone.new(0,   0,   0,   0),
		 Tone.new(-15,-45,-5,0),    # 6PM
     Tone.new(-35,-55,-5,0),
     Tone.new(-65,-75,-5,0),
     Tone.new(-105,-95,-5,0),
		 Tone.new(-105,-95,-5,0),
		 Tone.new(-105,-95,-5,0)#Tone.new(-142.5,-142.5,-22.5,68)
  ]
	
	#Notte1 Tone.new(-105,-145,-25,0)
	#Notte2 Tone.new(-85,-115,-5,0)
	#Notte3 Tone.new(-105,-95,-5,0)
...
def pbDayNightTint(object)
  if [126].include?($game_map.map_id) #3 cansiria
    return
  end
