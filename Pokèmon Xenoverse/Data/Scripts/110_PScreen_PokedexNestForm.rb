...
class PokemonNestMapScene
  def pbStartScene(species,regionmap=-1)
    ...
    if $PokemonGlobal.pokedexDex==0
      ...
      @sprites["background"].setBitmap(_INTL("Graphics/Pictures/Dex/pokedexNest"))
...
class PokedexFormScene
  def pbStartScene(species)
    ...
    if $PokemonGlobal.pokedexDex==0
      ...
      @sprites["animbg"].bitmap=pbBitmap("Graphics/Pictures/Dex/animbg")
      @sprites["background"]=IconSprite.new(0,0,@viewport)
      @sprites["background"].setBitmap(_INTL("Graphics/Pictures/Dex/pokedexform")) # TODO da cambiare con l'uscita dalla parte 2
      ...
      @sprites["animbg"].bitmap=pbBitmap("Graphics/Pictures/Dex/xanimbg")
      @sprites["background"]=IconSprite.new(0,0,@viewport)
      @sprites["background"].setBitmap(_INTL("Graphics/Pictures/Dex/xpokedexForm"))
      @sprites["info"]=BitmapSprite.new(Graphics.width,Graphics.height,@viewport)
      @sprites["front"]=PokemonSprite.new(@viewport)
      @sprites["back"]=PokemonSprite.new(@viewport)
      @sprites["icon"]=PokemonSpeciesIconSprite.new(@species,@viewport)
  ...
  def pbUpdate
    ...
    pbPositionPokemonSprite(@sprites["back"],310,55+16+backMetric*2)
#    @sprites["icon"].update
  end
