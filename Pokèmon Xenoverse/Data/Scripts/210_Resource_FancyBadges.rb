...
#-------------------------------------------------------------------------------
#  NormalRotation for trainer card scene by xZekro51:.
#-------------------------------------------------------------------------------
def normalBadgeAnimation(badge_number=0,totframes=1)
  @totframes=totframes
  $Trainer.badges[badge_number] = true
  pbMEPlay("getBadge")
  height = defined?(SCREENDUALHEIGHT) ? DEFAULTSCREENHEIGHT : Graphics.height
  viewport = Viewport.new(-100,130,Graphics.width,height)
  viewport.z = 99999
...
=end 
  ...
  zoom_x = 1 # don't change
  zoom_y = 1 # don't change
